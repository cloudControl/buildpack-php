...
# release.sh sets the PHP_INI_SCAN_DIR for legacy builds
# This should be removed in the future so remove now.
# As soon as all applications are built with the new one
# this can be removed
